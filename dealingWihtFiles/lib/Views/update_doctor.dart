...
class UpdateDoctor extends StatefulWidget {
  const UpdateDoctor({Key? key, required this.doctor}) : super(key: key);
...
class _UpdateDoctorState extends State<UpdateDoctor> {
  ...
  void initState() {
    ...
    super.initState();
    _nameCtr.text = widget.doctor.name!;
    _idCtr.text = widget.doctor.id.toString();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("Update Doctor"), centerTitle: true,),
      body: Container(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: ()async{
          if (_formKey.currentState!.validate()) {
            ...
            var isDone= await doctorProvider.updateDoctor(dr);
            if(isDone){
